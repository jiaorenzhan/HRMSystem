...
%>
 <base href=" <%=basePath%>">
	...
	<body>
	<%
	    Jobs job=(Jobs) request.getAttribute("a");
	%>
		<!-- 页面头部 -->
							...
							<tr>
								...
								<td width="347" height="24" bgcolor="#FFFFFF">
									<input name="job_id" type="text" id="job_id"
										readonly="readonly" value=<%=job.getJid() %>>
									*
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td height="24" bgcolor="#FFFFFF">
									<input name="max_salary" type="text" id="max_salary"
										value="<%=job.getMaxwage()%>">
									*
								</td>
							</tr>
							<tr>
								<td height="24" colspan="2" align="center" bgcolor="#FFFFFF">
								<!--  	<input type="button" name="Submit" value="更新" onClick="alert('修改职务成功');location.href='JobsViewServlet'">
