...
%>
 <base href=" <%=basePath%>">
	...
	<body>
	  <%
	    Department depart=(Department) request.getAttribute("a");
							...
							<tr>
								...
								<td height="24" bgcolor="#FFFFFF">
									<input name="location_name" type="text" id="location_name"
										value="<%=depart.getAddress() %>">
									*
								</td>
							</tr>
							<tr>
								<td height="24" colspan="2" align="center" bgcolor="#FFFFFF">
									<!--  <input type="button" name="Submit" value="更新" onClick="alert('更新部门数据成功');location.href='DeptViewServlet'">
